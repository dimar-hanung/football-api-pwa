...
if (workbox) {
  ...
  workbox.precaching.precacheAndRoute(
    [
      ...
      { url: "/assets/pages/info.html", revision: "1" },
      { url: "/assets/pages/competitions.html", revision: "1" },
      { url: "/assets/pages/favorit.html", revision: "1" },
      { url: "/assets/pages/home.html", revision: "1" },
      { url: "/assets/pages/schedule.html", revision: "1" },
      { url: "/assets/pages/standings.html", revision: "1" },
      { url: "/assets/pages/teams.html", revision: "1" },
      ...
      { url: "/assets/js/favorit.js", revision: "1" },
